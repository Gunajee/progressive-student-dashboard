...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Automatic login is performed on context level
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50/50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="mt-6 text-3xl font-extrabold text-gray-900 tracking-tight">Create student account</h2>
        <p className="mt-2 text-sm text-gray-500 font-medium">
          Start your learning progress tracking today
        </p>
      </div>
